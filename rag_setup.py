...
from langchain_text_splitters import RecursiveCharacterTextSplitterimport pandas as pd
import os
import sqlite3
from datetime import datetime
from dotenv import load_dotenv
...
def play_voice_male(text):
    async def _generate():
        ...
        # rate="-5%" se bolne ki speed thori normal ho jayegi taake samajh aaye
...
with tab_chat:
    ...
    # Yahan tabdeeli ki thi: Screen ko 3 hisson mein taqseem kiya tha taake chat center mein widget ki tarha aaye
